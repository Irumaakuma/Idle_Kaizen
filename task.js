...
class Skill {
  constructor({ id, name, baseXpGain = 2, baseEffect = 0.01, group = "autre", unlocked = true, getBonusDamage, getBonusDodge, getTripleHitChance, getIgnoreDefense, maxLevel }) {
    this.id = id;
    this.name = name;
    this.level = 1;
    this.xp = 0;
