class Task {
  constructor(id, name, baseXpPerTick = 10) {
    this.id = id;
    this.name = name;
    this.level = 0;
    this.xp = 0;
...
class Skill {
  constructor({ id, name, baseXpGain = 10, baseEffect = 0.05, group = "autre", unlocked = true, getBonusDamage, getBonusDodge, getTripleHitChance, getIgnoreDefense, maxLevel }) {
    this.id = id;
    this.name = name;
    this.level = 1;
    this.xp = 0;
...
window.defaultSkills = {
  force:       new Skill({ id: "force", name: "Force", baseXpGain: 10, baseEffect: 0.01, group: "fondamentale" }),
  agilite:     new Skill({ id: "agilite", name: "Agilité", baseXpGain: 10, baseEffect: 0.01, group: "fondamentale" }),
  vitalite:    new Skill({ id: "vitalite", name: "Vitalité", baseXpGain: 10, baseEffect: 0.01, group: "fondamentale" }),
  vigueur:     new Skill({ id: "vigueur", name: "Vigueur", baseXpGain: 10, baseEffect: 0.01, group: "fondamentale" }),
  intelligence:new Skill({ id: "intelligence", name: "Intelligence", baseXpGain: 10, baseEffect: 0.01, group: "fondamentale" }),
  endurance:   new Skill({ id: "endurance", name: "Endurance", baseXpGain: 10, baseEffect: 0.01, group: "fondamentale" }),
  dexterite:   new Skill({ id: "dexterite", name: "Dextérité", baseXpGain: 10, baseEffect: 0.01, group: "fondamentale" }), // ↖️ priorité
